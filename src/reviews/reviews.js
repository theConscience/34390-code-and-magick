...
var reviewsFilter = document.querySelector('.reviews-filter'),
  // reviewTemplate = document.querySelector('#review-template'), to render
  // reviewElementToClone = null, to render
  reviewsListContainer = document.querySelector('.reviews-list'),
  moreReviewsButton = document.querySelector('.reviews-controls-more');
  //reviewsSection = document.querySelector('.reviews'); to load


// if ('content' in reviewTemplate) {  // находим шаблон  to render
...
// /** @param {function(Array.<Object>)} callback */  to load
